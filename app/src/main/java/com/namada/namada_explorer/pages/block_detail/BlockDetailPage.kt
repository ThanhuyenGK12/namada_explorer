...
fun BlockDetailPage(
    ...
    if (!isLoaded) {
        viewModel.loadUiData(blockID = blockID)
        isLoaded = true
    }
        ...
        Surface(
            ...
            LazyColumn(
                ...
                if (viewModel.uiState.isLoading) {
                    ...
                    val block = viewModel.uiState.block ?: return@LazyColumn
                    item {
                        CardData(
                            title = "ID",
                            value = blockID.uppercase(),
                    ...
                    item {
                        CardData(
                            ...
                            value = block.header.proposerAddress.uppercase(),
                            modifier = Modifier.fillMaxWidth()
                        )
                    }
                    item {
                    ...
                    item {
                        CardData(
                            ...
                            value = block.txHashes.size.toString(),
                            modifier = Modifier.fillMaxWidth()
                        )
                    }
                    item {
